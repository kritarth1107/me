...
export default function index() {
  return (
    <div className="px-4 flex flex-col justify-between h-screen w-full">
      <Head>
        ...
        <meta
          ...
          content="Specializing in zkFHE and blockchain privacy solutions."
        />
        <meta
          name="twitter:image"
          content="https://kritarthagrawal.com/kritarth-agrawal.png"
      ...
      <div className="max-w-[1200px] mx-auto w-full">
        <nav className="flex flex-row item-center justify-between py-8">
          ...
          <div className="flex flex-row items-center gap-3">
            <Link href="https://x.com/kritarthagrawal" target="_blank">
              <RiTwitterXLine size={23} />
            </Link>
            <Link
              href="https://www.linkedin.com/in/kritarthagrawal/"
              target="_blank"
            >
              <FaLinkedin size={25} />
            </Link>
      ...
      <div className="flex flex-col gap-[80px] max-w-[1200px] mx-auto w-full">
        <div className="flex flex-col-reverse  tabletPortrait:flex-row justify-between gap-8 laptop:gap-0">
          {/* Name */}
          <div className="flex flex-col">
            <span className="font-semibold text-[24px]">Hello I&apos;m,</span>
            <span className="font-bold text-[80px] tabletPortrait:text-[100px] tabletLandscape:text-[120px] laptop:text-[160px] tracking-tight leading-[100px] 
           tabletPortrait:leading-[110px] tabletLandscape:leading-[120px] laptop:leading-[150px]">
              Kritarth A.
            </span>
            <span className="font-extralight  text-[20px] text-[#4B4B4B]">
              Co-founder & CTO at{" "}
              <Link href="https://airchains.io" target="_blank">
                <span className="underline">Airchains</span>
              </Link>
            </span>
          </div>
          {/* Image */}
        ...
        <div className="flex flex-col laptop:flex-row justify-between gap-8 laptop:gap-0">
          {/* Content */}
          <div className="flex flex-row items-center gap-8">
            <Image
              width={1000}
              height={1000}
              className="h-40 w-auto hidden laptop:block"
              src="/guidance_up-arrow.png"
              alt="kritarth-agrawal-co-founder-airchains"
            />

            <span className="laptop:max-w-[500px] leading-[38px] text-[18px] font-light">
              With a Computer Science background, I lead Airchains&apos; efforts
              to integrate zkFHE, making blockchain indispensable for real-world
              use.
            </span>
          </div>
          {/* Links */}
          <div className="flex flex-row laptop:flex-col gap-4 text-right">
            <div>
              <Link
                href="https://docsend.com/view/a8hrvn5vfhd94nqb"
                target="_blank"
              >
                <span className="text-[#ACACAC] font-light underline">
                  Whitepaper
                </span>
              </Link>
            </div>
            <div>
              <Link href="https://kritarthagrawal.medium.com/" target="_blank">
                <span className="text-[#ACACAC] font-light underline">
                  Medium
                </span>
              </Link>
            ...
            <div>
              <Link href="https://github.com/airchains-network" target="_blank">
                <span className="text-[#ACACAC] font-light underline">
                  Github
                </span>
              </Link>
      ...
      <div className="bg-[#FCFCFC] py-6">
        <div className="max-w-[1200px] mx-auto w-full">
          <span className="text-[#A7A7A7] font-thin">
            In blockchain, confidentiality isn&apos;t just a feature—it&apos;s
            the foundation of trust in a decentralized world.
          </span>
        </div>
      </div>
    </div>
